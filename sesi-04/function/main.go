...
func main() {
	...
	greet2("Alexandra", "Marmalaede")
	fmt.Println(strings.Repeat("-", 25))

	var names = []string{"RT", "Bani"}
	var printMsg = greet3("Sebut namanya", names)
	...
	studentLists := print("Cynical", "Historical", "Biblical", "Lyrical", "Rhyme Bitcehss!")
	fmt.Printf("%v\n", studentLists)
	fmt.Println(strings.Repeat("-", 25))
	...
	profile("Recognize", "Gogoso", "Kapurung", "Nasi Padang", "sate padang")
	fmt.Println(strings.Repeat("-", 25))
